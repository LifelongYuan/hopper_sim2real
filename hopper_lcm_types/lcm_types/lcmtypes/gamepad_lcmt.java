...
public final class gamepad_lcmt implements lcm.lcm.LCMEncodable
{
    ...
    public static final long LCM_FINGERPRINT_BASE = 0xbc69aee0053d67d0L;
    ...
    public void _encodeRecursive(DataOutput outs) throws IOException
    {
        ...
        outs.writeInt(this.home); 
 
        outs.writeInt(this.start); 
 
        outs.writeInt(this.select); 
 
        outs.writeInt(this.thumbl); 
 
        outs.writeInt(this.thumbr); 
 
        outs.writeInt(this.point); 
    ...
    public void _decodeRecursive(DataInput ins) throws IOException
    {
        ...
        this.home = ins.readInt();
 
        this.start = ins.readInt();
 
        this.select = ins.readInt();
 
        this.thumbl = ins.readInt();
 
        this.thumbr = ins.readInt();
 
        this.point = ins.readInt();
    ...
    public lcmtypes.gamepad_lcmt copy()
    {
        ...
        outobj.home = this.home;
 
        outobj.start = this.start;
 
        outobj.select = this.select;
 
        outobj.thumbl = this.thumbl;
 
        outobj.thumbr = this.thumbr;
 
        outobj.point = this.point;
